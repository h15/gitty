...
=head2 Change default configuration.

Normally all configuration consists in C<./lib/Gitty.pm> file.
You should change it to protect your service.
...
=head1 Errors
    ...
    [-] Please change default data base params.
        You can get more information in README file.

You can see this message if you use default data base params or do not set yours params.
To fix it edit config in file C<./lib/Gitty.pm>.
